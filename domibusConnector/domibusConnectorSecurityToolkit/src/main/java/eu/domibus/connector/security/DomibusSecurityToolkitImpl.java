...
public class DomibusSecurityToolkitImpl {
...
//                    + ".pdf"
//                    : businessPdf.getName();
//            dssDocument = createLargeFileBasedDssDocument(businessPdf, pdfName, MimeTypeEnum.PDF);
//
//
...
//            dssDocument = createLargeFileBasedDssDocument(businessXml, MAIN_DOCUMENT_NAME + ".xml", MimeTypeEnum.XML);
//        } else {
